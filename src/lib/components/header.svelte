...
<header>
  <div class="crt sticky w-full top-0 z-50 bg-black/96 border-b-1 border-gray-400">
  ...
  <div class="h-24 sm:h-36 overflow-hidden border-b-1 border-gray-400 bg-black/96 shadow-white/10 shadow-xl/50">
    <Banner />
  </div>
</header>
