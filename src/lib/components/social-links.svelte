<script lang="ts">
  ...
  function animateLinks() {
    container.querySelectorAll<HTMLElement>(".svg-icon").forEach((el, i) => {
...
<div bind:this={container} class="flex flex-row gap-6 justify-center h-6">
  {#if props["spotify"]}
    <a href={props.spotify} target="_blank" rel="noopener noreferrer" aria-label="Spotify" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">Spotify</span>
      <svg class="svg-icon flash-spotify fill-white group-hover:fill-green-500" viewBox="-3 -3 38 38" aria-hidden="true">
  ...
  {#if props["youtube"]}
    <a href={props.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">YouTube</span>
      <svg class="svg-icon flash-youtube fill-white group-hover:fill-red-600" viewBox="0 0 256 256" aria-hidden="true">
  ...
  {#if props["discord"]}
    <a href={props.discord} target="_blank" rel="noopener noreferrer" aria-label="Discord" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">Discord</span>
      <svg class="svg-icon flash-discord fill-white group-hover:fill-indigo-700" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {#if props["instagram"]}
    <a href={props.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">Instagram</span>
      <svg class="svg-icon flash-instagram fill-white group-hover:fill-pink-500" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {#if props["facebook"]}
    <a href={props.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">Facebook</span>
      <svg class="svg-icon flash-facebook fill-white group-hover:fill-blue-600" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {#if props["email"]}
    <a href={`mailto:${props.email}`} aria-label="Email" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      <span class="tooltip">Email</span>
      <svg class="svg-icon flash-email fill-white group-hover:fill-red-400" viewBox="0 0 24 24" aria-hidden="true">
...
<style>
  ...
  :global {
    @keyframes flash-apple      { 0%,100% { fill: white } 50% { fill: #f43f5e } }
    @keyframes flash-bandcamp   { 0%,100% { fill: white } 50% { fill: #0d9488 } }
    @keyframes flash-deezer     { 0%,100% { fill: white } 50% { fill: #a855f7 } }
    @keyframes flash-discord    { 0%,100% { fill: white } 50% { fill: #4338ca } }
    @keyframes flash-email      { 0%,100% { fill: white } 50% { fill: #f87171 } }
    @keyframes flash-facebook   { 0%,100% { fill: white } 50% { fill: #2563eb } }
    @keyframes flash-instagram  { 0%,100% { fill: white } 50% { fill: #ec4899 } }
    @keyframes flash-soundcloud { 0%,100% { fill: white } 50% { fill: #f97316 } }
    @keyframes flash-spotify    { 0%,100% { fill: white } 50% { fill: #22c55e } }
    @keyframes flash-youtube    { 0%,100% { fill: white } 50% { fill: #dc2626 } }
  }
</style>
