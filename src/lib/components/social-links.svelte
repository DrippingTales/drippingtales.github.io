...
<div bind:this={container} class="flex flex-row gap-6 justify-center h-6">
  {#if props["spotify"]}
    <a href={props.spotify} target="_blank" rel="noopener noreferrer" aria-label="Spotify" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      ...
      <svg class="svg-icon flash-spotify fill-white group-hover:fill-green-500" viewBox="0 0 32 32" aria-hidden="true">
  ...
  {#if props["deezer"]}
    <a href={props.deezer} target="_blank" rel="noopener noreferrer" aria-label="Deezer" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      ...
      <svg class="svg-icon flash-deezer fill-white group-hover:fill-purple-500" viewBox="0 0 1433 1431" aria-hidden="true">
  ...
  {#if props["apple_music"]}
    <a href={props.apple_music} target="_blank" rel="noopener noreferrer" aria-label="Apple Music" class="group relative flex items-center gap-2 text-white font-medium rounded-lg">
      ...
      <svg class="svg-icon flash-apple fill-white group-hover:fill-rose-500" viewBox="0 0 24 24" aria-hidden="true">
