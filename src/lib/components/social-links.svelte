...
<div bind:this={container} class="flex flex-row gap-6 justify-center h-6">
  {#if props["spotify"]}
    <a href={props.spotify} target="_blank" rel="noopener noreferrer" aria-label="Spotify" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["deezer"]}
    <a href={props.deezer} target="_blank" rel="noopener noreferrer" aria-label="Deezer" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["apple_music"]}
    <a href={props.apple_music} target="_blank" rel="noopener noreferrer" aria-label="Apple Music" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["soundcloud"]}
    <a href={props.soundcloud} target="_blank" rel="noopener noreferrer" aria-label="Soundcloud" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["bandcamp"]}
    <a href={props.bandcamp} target="_blank" rel="noopener noreferrer" aria-label="Bandcamp" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["youtube"]}
    <a href={props.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["discord"]}
    <a href={props.discord} target="_blank" rel="noopener noreferrer" aria-label="Discord" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["instagram"]}
    <a href={props.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["facebook"]}
    <a href={props.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="group flex items-center gap-2 text-white font-medium rounded-lg">
  ...
  {#if props["email"]}
    <a href={`mailto:${props.email}`} aria-label="Email" class="group flex items-center gap-2 text-white font-medium rounded-lg">
